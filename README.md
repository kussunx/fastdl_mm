...
Metamod. It serves game resources over HTTP and has been validated with
Counter-Strike 1.6 Steam and ReHLDS.

## Design and compatibility

The plugin runs libmicrohttpd workers inside the 32-bit HLDS/ReHLDS process. File I/O,
...
The plugin uses standard GoldSrc and Metamod interfaces, so it has no mandatory
ReHLDS or ReGameDLL runtime API dependency.
...
substitute for measuring your own asset set.
